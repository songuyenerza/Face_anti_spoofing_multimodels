...
def get_default_config():
    ...
    # dataset
    conf.train_root_path = '/media/anlab/0e731fe3-5959-4d40-8958-e9f6296b38cb/home/anlab/songuyen/Download/data_spoof/data_train_200k/spoofing/1_80x80'
    conf.val_root_path = './datasets/test/1_80x80'
